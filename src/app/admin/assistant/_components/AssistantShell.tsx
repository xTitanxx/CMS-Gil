  ...
  return (
    <div className="flex h-full flex-col md:flex-row">
      ...
      >
        ...
        <button
          onClick={() => setTab("chat")}
          className="absolute right-2 z-30 flex h-10 w-10 items-center justify-center rounded-full bg-white/95 text-[#0d0d0d] ring-1 ring-black/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_6px_18px_rgba(0,0,0,0.18)] hover:bg-white active:bg-white md:hidden"
