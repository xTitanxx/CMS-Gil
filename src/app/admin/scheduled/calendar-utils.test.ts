...
describe("groupEntriesByDate", () => {
  it("groups entries by date key", () => {
    const entries: CalendarEntry[] = [
      { postId: "a", date: "2026-04-06", time: "12pm", status: "PENDING", platforms: ["INSTAGRAM"], thumbUrl: null, body: "foo" },
      { postId: "b", date: "2026-04-06", time: "3pm", status: "PUBLISHED", platforms: ["LINKEDIN"], thumbUrl: null, body: "bar" },
      { postId: "c", date: "2026-04-07", time: null, status: "IMPORTED", platforms: [], thumbUrl: null, body: "baz" },
    ];
