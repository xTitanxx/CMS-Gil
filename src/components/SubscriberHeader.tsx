...
export async function SubscriberHeader() {
  ...
  if (role === "subscriber" && session) {
    return (
      ...
      >
        <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-x-3 gap-y-2 px-4 py-2 text-sm">
  ...
  // subscriber gets — Feed, Talk to the Archivist, Bookmarks, plus an "Admin"
  // pill and Sign out — so engagement features (like, bookmark, comment) are
