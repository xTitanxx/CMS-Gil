...
- `PUBLIC_GATE_ENABLED=true` — turns on subscriber gate; `proxy.ts` redirects unauthenticated visitors on `/`, `/p/*`, `/s/*`, `/chat` to `/welcome`. Flipping false reopens the public site immediately.
