  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      >
        ...
        <div className="mt-3 shrink-0 min-h-[120px] rounded-xl border border-gray-200 bg-white p-3">
        ...
        <div className="mt-3 shrink-0 flex items-center gap-2 rounded-xl border border-purple-200 bg-purple-50 px-3 py-2">
